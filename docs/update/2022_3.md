...
* Displays the version of the loaderAffichage de la version du loader (en bas à droite)

* When we press space the informations(and commetns) of the software is displayed. Up and down arrows are availables to navigate into this page
