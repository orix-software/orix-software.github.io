...
tab_command=("bank" "basic10" "basic11" "bootfd"  "cat"   "cd"     "cksum" "clear" "otimer" "dsk-util" "echo"  "env"   "forth" "grep" "help" "hexdump"  "ioports" "list" "ls"    "lscpu" "lsmem" "man"   "mkdir" "mount" "orixcfg" "pwd"   "ps"     "reboot" "rm"    "setfont" "sh"    "submit" "touch" "twil"  "uname" "untar" "vidplay" "viewscr" "viewhrs" )
tab_repo=("shell"   "shell"   "shell"   "bootfd"  "shell" "shell"  "cksum" "shell" "shell"  "dsk-util" "shell" "shell" "forth"  "grep" "shell" "hexdump" "shell"  "list"  "shell" "shell" "shell" "shell" "shell" "shell" "orixcfg" "shell" "shell"  "shell"  "shell" "shell"   "shell" "submit" "shell" "shell" "shell" "untar" "vidplay" "viewscr" "shell")
